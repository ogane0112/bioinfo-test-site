...
const TermsOfService: React.FC = () => {
  return (
    <article className="p-4 sm:p-8 lg:p-12 max-w-screen-lg mx-auto">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">利用規約</h1>
      <p className="mb-6">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第1条（適用）</h2>
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第2条（利用登録）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第3条（ユーザーIDおよびパスワードの管理）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第4条（利用料金および支払方法）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第5条（禁止事項）</h2>
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第6条（本サービスの提供の停止等）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第7条（利用制限および登録抹消）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第8条（退会）</h2>
      <p className="mb-6">ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第9条（保証の否認および免責事項）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第10条（サービス内容の変更等）</h2>
      <p className="mb-6">当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。</p>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第11条（利用規約の変更）</h2>
      <p className="mb-6">当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。</p>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第12条（個人情報の取扱い）</h2>
      <p className="mb-6">当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第13条（通知または連絡）</h2>
      ...
      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第14条（権利義務の譲渡の禁止）</h2>
      <p className="mb-6">ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第15条（準拠法・裁判管轄）</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2">
        <li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
        <li>本サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</li>
      </ol>

      <h2 className="text-2xl sm:text-3xl font-semibold mb-4">第16条 アプリケーション</h2>
      <p className="mb-6">当社アプリにおけるキャンペーンは当社が独自に行うもので、米Appleとは一切関係がありません。</p>
